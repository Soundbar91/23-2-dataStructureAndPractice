...
data1 = ["C", "F", "G", "E", "A", "B", "D", "H", "J", "I"]
value1 = ["씨", "에프", "쥐", "이", "에이", "비", "디", "에이치", "제이", "아이"]

map1 = BSTMap()
map1.Display("[삽입 전] : ")
for i in range(len(data1)) :
    map1.Insert(data1[i],value1[i])
    map1.Display("[삽입 %c] : "%data1[i])

print('[최대 키] : ', map1.FindMax().key)
print('[최소 키] : ', map1.FindMin().key)
print('[최대 키 - 순환] : ', map.FindMax_ver1().key)
print('[최소 키 - 순환] : ', map.FindMin_ver1().key)
